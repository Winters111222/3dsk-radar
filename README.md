...
Upwork/LinkedIn alert bridge: [`docs/UPWORK_LINKEDIN_ALERT_BRIDGE_CZ.md`](docs/UPWORK_LINKEDIN_ALERT_BRIDGE_CZ.md). Offline normalizátor zpracuje pouze alerty, které platforma doručila do uživatelovy schránky, kanonizuje přesné job/post URL a předá je existujícímu podepsanému ingestu jako outreach-locked discovery signály. Neobsahuje login automatizaci ani platformní scraping a nic nezapíná.
