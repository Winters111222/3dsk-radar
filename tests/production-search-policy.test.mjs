...
test("WIDE_MAX has exact five-dollar, 25-shard and bounded-concurrency boundaries", () => {
  ...
  assert.equal(config.run_id, "prod-wide-max-search-20260908-semantic-buyer-intent-v3");
  assert.equal(config.operation_id, "wide-max-search-semantic-buyer-intent-v3");
  assert.equal(config.reservation_id, "wide-max-budget-semantic-buyer-intent-v3");
});
