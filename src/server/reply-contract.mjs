...
export function buildReplyInstructions({ profile, opportunity, retry = false }) {
  ...
  const opportunityFacts = {
    ...
    engagement_track: opportunity.engagement_track,
  ...
  return [
    ...
    "For B2B_STUDIO, write from the studio/team perspective. For INDIVIDUAL_FREELANCE, write from the qualified specialist's first-person perspective and do not imply a large team or enterprise capacity.",
