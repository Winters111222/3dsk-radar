...
export const MODEL_PRICING_USD_PER_1M = Object.freeze({
  "gpt-5.6-luna": Object.freeze({ input: 0.20, cached_input: 0.02, output: 1.20 }),
...
export function estimateSearchCost({ model, usage, webSearchCalls = 0 }) {
  ...
  const uncachedInputUsd = uncachedTokens * pricing.input / 1_000_000;
  const cachedInputUsd = cachedTokens * pricing.cached_input / 1_000_000;
  const outputUsd = normalized.output_tokens * pricing.output / 1_000_000;
