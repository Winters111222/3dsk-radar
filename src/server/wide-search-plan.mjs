...
export const WIDE_SEARCH_SHARDS = Object.freeze([
  ...
  shard("scan_postproduction_worldwide", "Worldwide scan post-production",
    ["upwork.com", "freelancer.com", "peopleperhour.com", "guru.com", "codeur.com", "reddit.com", "forums.unrealengine.com", "polycount.com", "blenderartists.org", "discussions.unity.com"],
  ...
  shard("character_vendor_pipeline", "External character production",
    ["workwithindies.com", "remotegamejobs.com", "hitmarker.net", "gamesjobsdirect.com", "artstation.com", "gamejobs.co", "vfxengine.com", "greenhouse.io", "lever.co", "ashbyhq.com", "smartrecruiters.com", "workable.com", "teamtailor.com", "recruitee.com", "reddit.com", "forums.unrealengine.com", "polycount.com", "discussions.unity.com", "codeur.com"],
    "Find explicit current demand for realistic scanned humans, digital doubles, facial/FACS processing or delivery-ready human characters. Preserve B2B studio/vendor/team work and genuine individual freelance projects as separate engagement tracks, including small and single-asset tasks. Do not return permanent employee roles, generic Character Artist jobs, stylized character work, game-engine-only roles, Reallusion Character Creator software (CC3/CC4), iClone or Daz3D work."),
  shard("cultural_heritage_cz_sk", "CZ/SK cultural heritage 3D",
    ["ted.europa.eu", "nen.nipez.cz", "zakazky.gov.cz", "zakazky.krajbezkorupce.cz", "zakazky.kr-stredocesky.cz", "uvo.gov.sk", "josephine.proebiz.com", "mk.gov.cz", "fpu.sk", "culture.gov.sk", "eeagrants.org"],
    "Search Czech and Slovak open tender detail pages for photogrammetric 3D digitisation of museum collection objects, costumes, textiles, artefacts, sculptures and cultural heritage. Also allow an active CZ/SK grant call or a recently named funded recipient as HERITAGE_FUNDING_PARTNERSHIP / POTENTIAL_LEAD only when the exact source explicitly includes relevant 3D production and 3D.SK can participate directly or with an eligible institution. A grant is never OPEN_OPPORTUNITY and its amount is never buyer project budget. Physical capture must take place only in Czechia or Slovakia. Worldwide work qualifies only when the buyer supplies already captured photos/scans for remote post-production. Reject expired or generic grant pages, document/film scanning, scanner purchases, websites without 3D capture, immersive exhibition production, GIS, BIM, buildings, terrain and infrastructure."),
  shard("worldwide_multilingual_buyer_sweep", "Worldwide multilingual buyer sweep",
    ["upwork.com", "freelancer.com", "peopleperhour.com", "guru.com", "codeur.com", "reddit.com", "forums.unrealengine.com", "polycount.com", "blenderartists.org", "discussions.unity.com", "workwithindies.com", "remotegamejobs.com", "greenhouse.io", "lever.co", "ashbyhq.com", "smartrecruiters.com", "workable.com", "teamtailor.com", "recruitee.com", "ted.europa.eu", "find-tender.service.gov.uk", "contractsfinder.service.gov.uk", "sam.gov", "canadabuys.canada.ca", "ungm.org", "procurement-notices.undp.org", "worldbank.org", "een.ec.europa.eu", "zakazky.gov.cz", "zakazky.krajbezkorupce.cz", "zakazky.kr-stredocesky.cz", "josephine.proebiz.com", "mk.gov.cz", "fpu.sk", "culture.gov.sk", "eeagrants.org"],
